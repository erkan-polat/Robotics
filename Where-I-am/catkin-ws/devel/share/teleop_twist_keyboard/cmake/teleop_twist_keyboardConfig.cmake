...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/erkan/Desktop/Where-I-am/catkin-ws/src/teleop-twist-keyboard-master)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/erkan/Desktop/Where-I-am/catkin-ws/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/erkan/Desktop/Where-I-am/catkin-ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/erkan/Desktop/Where-I-am/catkin-ws/src/teleop-twist-keyboard-master/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/erkan/Desktop/Where-I-am/catkin-ws/devel/lib;/opt/ros/kinetic/lib)
